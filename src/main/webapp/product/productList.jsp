			...
			<c:forEach items="${productList}" var="productDTO">
				<div class="product">
					<div class="productImage"><a
							href="phonetail.do?command=productDetail&pseq=${productDTO.pseq}"><img src="product/images/${productDTO.saveimagefile}" width="350px"/></a></div>
					<div class="productModel"><a
							href="phonetail.do?command=productDetail&pseq=${productDTO.pseq}">${productDTO.model}</a></div>
					<div class="productPrice">${productDTO.price}</div>
					<div class="productUserid">${productDTO.userid}</div>
				</div>
			</c:forEach>
